...
extension String {
    ...
    public func isMobile() -> Bool {
        let mobileRegex = "^1([358][0-9]|4[579]|66|7[0135678]|9[89])[0-9]{8}$"
        return isValidateByRegex(mobileRegex)
    }
...
extension String {
    ...
    public func timeInterval(_ formater: String = KKXDate) -> TimeInterval? {
